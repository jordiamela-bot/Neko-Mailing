	...
	function seleccionar(id,wi) {  //pones una imagen nueva 
		...
		$('#'+valor).find('img').attr('data-tanto',50); //en el diseño
	...
	function poner_texto() {  //texto en directo
		...
		if(palinear_imagen=="center") pestilo="style='text-align:center;margin-bottom:0px;'";
                ...
                pimg="<table border='0' cellspacing='0' cellpadding='0' width='100%'><tr><td><p "+pestilo+"><img src='"+pimagen+"' alt='"+palt_imagen+"' data-link_imagen='"+plink_imagen+"' data-alinear_imagen='"+palinear_imagen+"' width='"+wid+"' data-width='"+size+"' data-ids='"+valor+"' data-tanto='"+wi+"'></p></td></tr></table>";
                valor="#"+valor;
                $(valor).html(pimg);
                ...
                $.ajax({
                        type: 'post',
                         url: 'guardar_modulos.php',
                               data:{id_profile:pprofile,id:valor_id,datos:pdatos,id_diseno:pdiseno,id_background:pbackground,id_tamano_letra:ptamano_letra,id_color_letra:pcolor_letra,id_alineacion:palineacion,id_tipo_letra:ptipo_letra,line:valor_line,porden:orden,id_campana:pcampana},
                               success: function(response){
	...
	//Boton Guardar Módulos de Texto
		...
		pcampana=$('#id_campana').val();
                ...
                $.ajax({
                        type: 'post',
                         url: 'guardar_modulos.php',
                               data:{id_profile:pprofile,id:valor_id,datos:pdatos,id_diseno:pdiseno,id_background:pbackground,id_tamano_letra:ptamano_letra,id_color_letra:pcolor_letra,id_alineacion:palineacion,id_tipo_letra:ptipo_letra,id_mensaje:pmensaje,id_tipo:tipo,line:valor_line,porden:orden,id_campana:pcampana},
                               success: function(response){
                                        diseno=response.split("|");
                                        $("#id_diseno").val(diseno[0]);
                                        //$("#id_diseno_linea_").val(diseno[1]);
	 ...
	 $("#guardar_esp").on("click", function(event){
		...
		pcampana=$('#id_campana').val();
                ...
                $.ajax({
                        type: 'post',
                         url: 'guardar_modulos.php',
                               data:{id_profile:pprofile,id:valor_id,datos:pdatos,id_diseno:pdiseno,id_background:pbackground,id_tamano_letra:ptamano_letra,id_color_letra:pcolor_letra,id_alineacion:palineacion,id_tipo_letra:ptipo_letra,id_line_height:pline_height,id_tipo:tipo,line:valor_line,porden:orden,id_campana:pcampana},
                               success: function(response){
...
*/
	...
	$("#seguir").on("click", function(event){
		...
		$.ajax({
                        type: 'post',
                        url: 'guardar_modulos.php',
                        data:{id_profile:pprofile,datos:pdatos,id_diseno:pdiseno,id_dencam:pdencam,id_background:pbackground,id_tamano_letra:ptamano_letra,id_color_letra:pcolor_letra,id_alineacion:palineacion,id_tipo_letra:ptipo_letra,porden:orden,id:pid,line:pline},
                        success: function(response){
                                     diseno=response.split("|");
                                     $("#id_diseno").val(diseno[0]);
