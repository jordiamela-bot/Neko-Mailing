	...
	$("#guardar_bot").on("click", function(event){
	 ...
	 //Boton Guardar Módulos de Texto
		...
		tpos=$('input:radio[name=id_posicion_imt]:checked').val(); console.log('tpos '+tpos);
                ...
                console.log('He clickado IMG'+diseno+' '+valor_id+' '+tipo+' '+valor_line+' '+pimagen+' '+plink_imagen+' '+palt_imagen+' '+palinear_imagen+' '+size+' '+wi );
				       ...
				       if(response.ok)
				       {
					       ...
					       if(tipo=="imagen_texto")
							...
							wid=this.Width*this.Tanto/100; 
						        /*if(wid>300) wid=300*wi/100;*/
						        if(wid>300) wid=300*this.Tanto/100;
