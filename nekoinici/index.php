...
<head>
    ...
    <link rel="icon" type="image/png" href="img/neko_logo.png">
...
<?php if($show_cookie_banner) { ?>
    <div style="text-align:center">
        <div id="cookie">
            ...
            <a href="#myModal_aviso" class="cookie_anchor" data-bs-toggle="modal" data-bs-target="#myModal_aviso"><b><?php echo public_home_h($privacy_policy); ?></b></a>.<br><br>
            <input type="button" class="btn boton_aceptar" value="<?php echo public_home_h($accept_text); ?>" onclick="publicHomeAcceptCookies(event)" id="cookie_click">
            &nbsp;&nbsp;&nbsp;
            <input type="button" class="btn btn-danger" value="<?php echo public_home_h($cancel_text); ?>" onclick="publicHomeDismissCookies(event)" id="cookie_click_cancelar">
        </div>
    </div>
<?php } ?>
                ...
                <div class="public-nav-wrap">
                    <div class="public-nav">
                        ...
                        <div class="public-nav-actions">
                            <div class="public-lang-switch" aria-label="<?php echo public_home_h($language_label); ?>">
                                <?php foreach($language_options as $lang_code => $lang_data) { ?>
                                    <a
                                        class="public-lang-link <?php if($idioma_publico === $lang_code) echo "is-active"; ?>"
                                        href="<?php echo public_home_h($language_links[$lang_code]); ?>"
                                        title="<?php echo public_home_h($lang_data["name"]); ?>"
                                        aria-label="<?php echo public_home_h($lang_data["name"]); ?>"
                                    ><?php echo public_home_h($lang_data["short"]); ?></a>
                                <?php } ?>
                            </div>
                            <a class="btn public-nav-button public-nav-button-secondary" href="<?php echo public_home_h($login_url); ?>"><?php echo public_home_h(public_home_text("nav_login", $idioma_publico)); ?></a>
                            <a class="btn public-nav-button public-nav-button-primary" href="<?php echo public_home_h($register_url); ?>"><?php echo public_home_h(public_home_text("register", $idioma_publico)); ?></a>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <section id="web" class="landing-view landing-view-home">
                    <div class="landing-hero">
                        <div class="landing-copy">
                            ...
                            <p class="landing-intro" style="font-size:1.6em;"><?php echo public_home_h($hero_intro); ?></p>
                            <div class="landing-actions">
                                <a class="btn landing-button landing-button-primary" href="<?php echo public_home_h($register_url); ?>"><?php echo public_home_h($hero_primary); ?></a>
                                <a class="btn landing-button landing-button-secondary" href="<?php echo public_home_h($login_url); ?>"><?php echo public_home_h($hero_secondary); ?></a>
                            </div>
                        ...
                        <div class="landing-visual">
                            <div class="landing-visual-board">
                                <figure class="visual-card visual-card-main">
                                    <img src="img/email3.jpg" alt="<?php echo public_home_h($portal_name); ?>" loading="lazy">
                                </figure>
                                <figure class="visual-card visual-card-secondary">
                                    <img src="img/email2.jpg" alt="<?php echo public_home_h($showcase_card_one); ?>" loading="lazy">
                                </figure>
                                <figure class="visual-card visual-card-tertiary">
                                    <img src="img/email.jpg" alt="<?php echo public_home_h($showcase_card_two); ?>" loading="lazy">
                                </figure>
                ...
                <div class="public-footer-inner">
                    <div class="public-footer-grid">
                        ...
                        <div class="public-footer-actions">
                            ...
                            <button type="button" class="public-footer-link public-footer-button" data-bs-toggle="modal" data-bs-target="#myModal_aviso">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo public_home_h($close_text); ?>"></button>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" data-bs-dismiss="modal"><?php echo public_home_h($close_text); ?></button>
            </div>
        </div>
    </div>
</div>
